...
class AddPillDialog : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.addpill_window)
        ...
        val addBtn = findViewById<Button>(R.id.AddButPill)
        ...
        addBtn.setOnClickListener {
            ...
            retrofit.createPill(obj)
                .enqueue(object : Callback<DefaultResponse> {
                    override fun onFailure(call: Call<DefaultResponse>, t: Throwable) {
                        Toast.makeText(applicationContext, "Mistake. Try again!", Toast.LENGTH_SHORT)
                            .show()
                    }
                    ...
                    override fun onResponse(
                        ...
                        val intent = Intent(applicationContext, Pill::class.java)
